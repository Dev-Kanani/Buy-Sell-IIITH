...
} from "./chunk-HHYYA2TK.js";
import {
  require_react_dom
} from "./chunk-TH7NCS4R.js";
import {
  require_hoist_non_react_statics_cjs
} from "./chunk-EAKRUDCA.js";
import {
  require_prop_types
...
var elementAcceptingRef = chainPropTypes(import_prop_types8.default.element, acceptingRef);
elementAcceptingRef.isRequired = chainPropTypes(import_prop_types8.default.element.isRequired, acceptingRef);
...
function getValidReactChildren(children2) {
  return React22.Children.toArray(children2).filter((child) => React22.isValidElement(child));
}
...
function mergeSlotProps(parameters) {
  ...
  if (!getSlotProps) {
    const joinedClasses2 = clsx_default3(additionalProps == null ? void 0 : additionalProps.className, className, externalForwardedProps == null ? void 0 : externalForwardedProps.className, externalSlotProps == null ? void 0 : externalSlotProps.className);
    const mergedStyle2 = {
...
var FormControlContext = React40.createContext(void 0);
if (true) {
...
function getChildMapping(children2, mapFn) {
  ...
  if (children2) import_react9.Children.map(children2, function(c) {
    return c;
...
ReplaceTransition.propTypes = true ? {
  ...
  children: function children(props, propName) {
    if (import_react11.default.Children.count(props[propName]) !== 2) return new Error('"' + propName + '" must be exactly two transition components.');
    return null;
  }
} : {};
...
function Ripple(props) {
  ...
  const [leaving, setLeaving] = React48.useState(false);
  ...
  return (0, import_jsx_runtime17.jsx)("span", {
    ...
    style: rippleStyles,
    children: (0, import_jsx_runtime17.jsx)("span", {
...
`;
var TouchRipple = React49.forwardRef(function TouchRipple2(inProps, ref) {
  ...
  const [ripples, setRipples] = React49.useState([]);
  const nextKey = React49.useRef(0);
  const rippleCallback = React49.useRef(null);
  React49.useEffect(() => {
  ...
  const ignoringMouseDown = React49.useRef(false);
  const startTimer = useTimeout();
  const startTimerCommit = React49.useRef(null);
  const container = React49.useRef(null);
  const startCommit = React49.useCallback((params) => {
    const {
      pulsate: pulsate2,
      rippleX,
      rippleY,
    ...
    setRipples((oldRipples) => [...oldRipples, (0, import_jsx_runtime18.jsx)(TouchRippleRipple, {
      classes: {
  ...
  const start = React49.useCallback((event = {}, options = {}, cb = () => {
  }) => {
    const {
  ...
  const pulsate = React49.useCallback(() => {
    start({}, {
      pulsate: true
    });
  }, [start]);
  const stop = React49.useCallback((event, cb) => {
    startTimer.clear();
  ...
  return (0, import_jsx_runtime18.jsx)(TouchRippleRoot, {
    className: clsx_default(touchRippleClasses_default.root, classes.root, className),
    ref: container,
    ...other,
    children: (0, import_jsx_runtime18.jsx)(TransitionGroup_default, {
      component: null,
      exit: true,
      children: ripples
    })
...
var ButtonBase = React50.forwardRef(function ButtonBase2(inProps, ref) {
  const props = useDefaultProps2({
    props: inProps,
    name: "MuiButtonBase"
  });
  ...
  return (0, import_jsx_runtime19.jsxs)(ButtonBaseRoot, {
    as: ComponentProp,
    ...
    ...buttonProps,
    ...other,
    children: [children2, enableTouchRipple ? (0, import_jsx_runtime19.jsx)(TouchRipple_default, {
      ref: handleRippleRef,
      center: centerRipple,
      ...TouchRippleProps
    }) : null]
...
var SwitchBase = React51.forwardRef(function SwitchBase2(props, ref) {
  const {
    autoFocus,
    checked: checkedProp,
    checkedIcon,
  ...
  return (0, import_jsx_runtime20.jsxs)(SwitchBaseRoot, {
    component: "span",
    className: clsx_default(classes.root, className),
    centerRipple: true,
    ...
    ref,
    ...other,
    children: [(0, import_jsx_runtime20.jsx)(SwitchBaseInput, {
      autoFocus,
      checked: checkedProp,
      defaultChecked,
...
var SvgIcon = React52.forwardRef(function SvgIcon2(inProps, ref) {
  const props = useDefaultProps2({
    props: inProps,
    name: "MuiSvgIcon"
  });
  ...
  const hasSvgAsChild = React52.isValidElement(children2) && children2.type === "svg";
  const ownerState = {
    ...props,
    color: color2,
    component,
...
function createSvgIcon(path, displayName) {
  ...
  return React53.memo(React53.forwardRef(Component));
}
...
var Checkbox = React57.forwardRef(function Checkbox2(inProps, ref) {
  const props = useDefaultProps2({
    props: inProps,
    name: "MuiCheckbox"
  });
  ...
  return (0, import_jsx_runtime26.jsx)(CheckboxRoot, {
    ...
    checkedIcon: React57.cloneElement(indeterminateIcon, {
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-GHYZRBVC.js.map
