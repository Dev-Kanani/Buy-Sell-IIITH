...
var Collapse = import_react2.default.forwardRef(({
  onEnter,
  onEntering,
  onEntered,
  onExit,
  ...
  const handleEnter = (0, import_react2.useMemo)(() => createChainedFunction_default((elem) => {
    elem.style[computedDimension] = "0";
  }, onEnter), [computedDimension, onEnter]);
  const handleEntering = (0, import_react2.useMemo)(() => createChainedFunction_default((elem) => {
    const scroll = `scroll${computedDimension[0].toUpperCase()}${computedDimension.slice(1)}`;
    elem.style[computedDimension] = `${elem[scroll]}px`;
  }, onEntering), [computedDimension, onEntering]);
  const handleEntered = (0, import_react2.useMemo)(() => createChainedFunction_default((elem) => {
    elem.style[computedDimension] = null;
  }, onEntered), [computedDimension, onEntered]);
  const handleExit = (0, import_react2.useMemo)(() => createChainedFunction_default((elem) => {
    elem.style[computedDimension] = `${getDimensionValue(computedDimension, elem)}px`;
    triggerBrowserReflow(elem);
  }, onExit), [onExit, getDimensionValue, computedDimension]);
  const handleExiting = (0, import_react2.useMemo)(() => createChainedFunction_default((elem) => {
    elem.style[computedDimension] = null;
  ...
  return (0, import_jsx_runtime3.jsx)(TransitionWrapper_default, {
    ...
    unmountOnExit,
    appear,
    children: (state, innerProps) => import_react2.default.cloneElement(children, {
      ...innerProps,
...
var NavbarToggle = React6.forwardRef(({
  ...
  const {
    onToggle,
    expanded
  } = (0, import_react4.useContext)(NavbarContext_default) || {};
...
function NoopTransition({
  ...
  const hasEnteredRef = (0, import_react10.useRef)(inProp);
...
function useTransition({
  ...
  const isInitialRef = (0, import_react12.useRef)(true);
...
function ImperativeTransition({
  ...
  const [exited, setExited] = (0, import_react12.useState)(!inProp);
  if (inProp && exited) {
    setExited(false);
  }
  ...
  const combinedRef = useMergedRefs_default(ref, children.ref);
  return exited && !inProp ? null : (0, import_react12.cloneElement)(children, {
    ref: combinedRef
  });
}
...
function useModalManager(provided) {
  ...
  const modal = (0, import_react13.useRef)({
    dialog: null,
    backdrop: null
  });
  return Object.assign(modal.current, {
    ...
    setDialogRef: (0, import_react13.useCallback)((ref) => {
      modal.current.dialog = ref;
    }, []),
    setBackdropRef: (0, import_react13.useCallback)((ref) => {
      modal.current.backdrop = ref;
    }, [])
  });
}
var Modal = (0, import_react13.forwardRef)((_ref, ref) => {
  let {
    show = false,
    role = "dialog",
    className,
  ...
  const [exited, setExited] = (0, import_react13.useState)(!show);
  const lastFocusRef = (0, import_react13.useRef)(null);
  (0, import_react13.useImperativeHandle)(ref, () => modal, [modal]);
  ...
  const removeFocusListenerRef = (0, import_react13.useRef)();
  const removeKeydownListenerRef = (0, import_react13.useRef)();
...
var divWithClassName_default = (className) => React17.forwardRef((p, ref) => (0, import_jsx_runtime16.jsx)("div", {
  ...p,
  ref,
...
var Offcanvas = React19.forwardRef(({
  ...
  const renderBackdrop = (0, import_react16.useCallback)((backdropProps) => (0, import_jsx_runtime18.jsx)("div", {
    ...backdropProps,
...
//# sourceMappingURL=chunk-LCJIOCHE.js.map
